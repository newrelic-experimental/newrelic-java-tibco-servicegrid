...
public abstract class JmsMetricUtil {
    ...
    public static void saveMessageParameters(Message msg) {
        if (msg != null) {
        	Map<String, String> msgProps = getMessageParameters(msg);
        	Set<String> keys = msgProps.keySet();
        	for(String key : keys) {
        		String value = msgProps.get(key);
    ...
    public static void processSendMessage(Message message, Destination dest, TracedMethod tracer) {
        ...
        try {
            ...
            tracer.reportAsExternal(MessageProduceParameters
                    ...
                    .outboundHeaders(new NRMessageOutbound(message))
                    .build());
    ...
    public static void processConsume(Message message, TracedMethod tracer) {
        ...
        try {
            ...
            MessageConsumeParameters params = MessageConsumeParameters.library("TibcoJMS").destinationType(destinationType).destinationName(destinationName).inboundHeaders(new NRMessageInbound(message)).build();
